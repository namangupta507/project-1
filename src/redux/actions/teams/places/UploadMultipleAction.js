...
import { uploadMultipleRequest, uploadMultipleRequestError, uploadMultipleRequestSuccess } from "../../../slices/teams/places/UploadMultipleSlice";


export const UploadMultipleAPI = (data, id) => {
    return async (dispatch) => {
        const url = `${endpoints.placesUploadMultiple}/${id}`
        try {

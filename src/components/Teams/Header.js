...
const Header = ({ isOpen, onToggleSidebar }) => {
    ...
    const pageHeading = (path) => {
        if (path.startsWith('/dashboard/teams/reimbursement/detail/')) {
            return 'Reimbursement Detail';
        }
        switch (path) {
            case '/dashboard/teams':
                return 'Home';
            case '/dashboard/teams/reimbursement':
                return 'Reimbursement';
            case '/dashboard/teams/members':
                return 'Members';
            case '/dashboard/teams/teams':
                return 'Teams';
            case '/dashboard/teams/data-exports':
                return 'Data-exports';
            case '/dashboard/teams/summary':
                return 'Summary';
            case '/dashboard/teams/profile':
                return 'Profile';
            case '/dashboard/teams/categories':
                return 'Categories';
            case '/dashboard/teams/places':
                return 'Team Places';
            case '/dashboard/teams/roles-permissions':
                return 'Roles & Permissions';
            case '/dashboard/teams/members/invite':
                return 'Members'
            case '/dashboard/update-delete-odometer-reading':
                ...
                <div className="row justify-content-between align-items-center">
                    <div className="col-5 col-md-5">
                        <div className="header-flex">
                            <button className={`opnBtn ${isOpen ? 'active' : ''}`} type="button" onClick={onToggleSidebar}>
                                <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors"><g clipPath="url(#clip0_5791_1036)"><path d="M9.32373 15L1.32373 7.78788L9.32373 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><path d="M15.1533 15L7.15332 7.78788L15.1533 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></g><defs><clipPath id="clip0_5791_1036"><rect width={16} height={16} fill="white" /></clipPath></defs></svg>
                            </button>
